...
NODATA = 255
EXPORT_FOLDER = "GEE_export"  # Google Drive folder
SCALE = 30
...
def main():
    ...
    land_cover_types = ['forest', 'cropland', 'pasture']
    ...
    for year in YEARS:
        ...
        for lc_type in land_cover_types:
            ...
            reference = build_terra(year, lc_type)
            prediction = build_mb(year, lc_type)

            results = compute_confusion(reference, prediction, region)

            export_metrics(year, lc_type, results)
